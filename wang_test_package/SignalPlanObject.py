...
class SignalPlan:
    ...
    def __init__(self,planID,IsCurrentRunPlan, order,cycle,offset,phases=[]):
        # RSUid,location,BGplan,ADplan
        # super(RSUid=RSUid,location=location,backgroundplan=BGplan,adaptiveplan=ADplan)
        self.planID = planID
        self.IsCurrentRunPlan = IsCurrentRunPlan  # 是否為正在執行plan (bool)
        self.planOrder = order  # ex. B0 00 01...
        self.cycle = cycle
        self.offset = offset
        self.phases = phases

    def setIsCurrentRunPlan(self, value):
        self.IsCurrentRunPlan = value #bool
